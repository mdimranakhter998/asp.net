...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=DESKTOP-18VC6QS;Database=Demo;Integrated Security=True;Trusted_Connection=True; Encrypt=False");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<TblBrand>(entity =>
        {
            ...
            entity.HasOne(d => d.Status).WithMany(p => p.TblBrands)
                .HasForeignKey(d => d.StatusId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_tbl_Brand_tbl_Status");
        });
        ...
        modelBuilder.Entity<TblShippingFee>(entity =>
        {
            ...
            entity.HasOne(d => d.City).WithMany(p => p.TblShippingFees)
                ...
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_tbl_ShippingFee_tbl_Country_City");
